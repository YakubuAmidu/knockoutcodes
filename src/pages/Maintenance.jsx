...
const DEFAULT_MESSAGE =
  "We are sharpening the platform, improving the training room, and preparing a better experience.";

function formatUpdatedDate(value) {
  if (!value) return "Maintenance in progress";
  ...
  return (
    <Page>
      <Card>
        ...
        <Text>{message || DEFAULT_MESSAGE}</Text>
