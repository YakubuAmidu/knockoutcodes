  ...
  return (
    <Page>
      ...
      >
        <Badge>
          <LiveDot />
          KNOCKOUTCODES • MEMBERSHIP STATUS
        </Badge>

        <Title>
          {canceled
            ? "Membership checkout cancelled."
            : "Membership payment did not complete."}
        </Title>
        ...
        <Card>
          ...
          <CardText>
            Premium access unlocks only after Stripe confirms payment and your
            subscription is safely saved to your account.
          </CardText>

          <Actions>
            <PrimaryLink to="/memberships">Choose Membership</PrimaryLink>
            <GhostLink to="/courses">Browse Courses</GhostLink>
            <GhostLink to="/dashboard">Go To Dashboard</GhostLink>
          </Actions>

          <SmallNote>
            If you believe you were charged, check your dashboard before trying
            again.
          </SmallNote>
        </Card>
      </Shell>
