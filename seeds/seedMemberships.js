...
// /**
//  * =========================================
//  * ✅ DEBUG STRIPE PRICE IDS
//  * =========================================
//  */

// console.log("\n=========================================");
// console.log("✅ STRIPE MEMBERSHIP PRICE IDS");
// console.log("=========================================\n");

// // eslint-disable-next-line no-undef
// console.log(
//   "BEGINNER MONTHLY:",
//   process.env.STRIPE_BEGINNER_MONTHLY_PRICE_ID || "❌ MISSING"
// );

// // eslint-disable-next-line no-undef
// console.log(
//   "BEGINNER YEARLY:",
//   process.env.STRIPE_BEGINNER_YEARLY_PRICE_ID || "❌ MISSING"
// );

// // eslint-disable-next-line no-undef
// console.log(
//   "INTERMEDIATE MONTHLY:",
//   process.env.STRIPE_INTERMEDIATE_MONTHLY_PRICE_ID || "❌ MISSING"
// );

// // eslint-disable-next-line no-undef
// console.log(
//   "INTERMEDIATE YEARLY:",
//   process.env.STRIPE_INTERMEDIATE_YEARLY_PRICE_ID || "❌ MISSING"
// );

// // eslint-disable-next-line no-undef
// console.log(
//   "ADVANCE MONTHLY:",
//   process.env.STRIPE_ADVANCE_MONTHLY_PRICE_ID || "❌ MISSING"
// );

// // eslint-disable-next-line no-undef
// console.log(
//   "ADVANCE YEARLY:",
//   process.env.STRIPE_ADVANCE_YEARLY_PRICE_ID || "❌ MISSING"
// );

// // eslint-disable-next-line no-undef
// console.log(
//   "COMPLETE MONTHLY:",
//   process.env.STRIPE_COMPLETE_MONTHLY_PRICE_ID || "❌ MISSING"
// );

// // eslint-disable-next-line no-undef
// console.log(
//   "COMPLETE YEARLY:",
//   process.env.STRIPE_COMPLETE_YEARLY_PRICE_ID || "❌ MISSING"
// );
...
//     // eslint-disable-next-line no-undef
//     stripePriceId:
//       process.env.STRIPE_BEGINNER_MONTHLY_PRICE_ID || "",
...
//     // eslint-disable-next-line no-undef
//     stripePriceIdYearly:
//       process.env.STRIPE_BEGINNER_YEARLY_PRICE_ID || "",
...
//     // eslint-disable-next-line no-undef
//     priceLabel:
//       process.env.MEMBERSHIP_INTERMEDIATE_MONTHLY_PRICE_LABEL ||
//       "$49/month",
...
//     // eslint-disable-next-line no-undef
//     yearlyPriceLabel:
//       process.env.MEMBERSHIP_INTERMEDIATE_YEARLY_PRICE_LABEL ||
//       "$490/year",
...
//     // eslint-disable-next-line no-undef
//     stripePriceIdYearly:
//       process.env.STRIPE_INTERMEDIATE_YEARLY_PRICE_ID || "",
...
//     // eslint-disable-next-line no-undef
//     priceLabel:
//       process.env.MEMBERSHIP_ADVANCE_MONTHLY_PRICE_LABEL ||
//       "$79/month",
...
//     // eslint-disable-next-line no-undef
//     yearlyPriceLabel:
//       process.env.MEMBERSHIP_ADVANCE_YEARLY_PRICE_LABEL ||
//       "$790/year",

//     // eslint-disable-next-line no-undef
//     stripePriceId:
//       process.env.STRIPE_ADVANCE_MONTHLY_PRICE_ID || "",
...
//     // eslint-disable-next-line no-undef
//     stripePriceIdYearly:
//       process.env.STRIPE_ADVANCE_YEARLY_PRICE_ID || "",
...
//     priceLabel:
//       // eslint-disable-next-line no-undef
//       process.env.MEMBERSHIP_COMPLETE_MONTHLY_PRICE_LABEL ||
//       "$99/month",
...
//     yearlyPriceLabel:
//       // eslint-disable-next-line no-undef
//       process.env.MEMBERSHIP_COMPLETE_YEARLY_PRICE_LABEL ||
//       "$990/year",
